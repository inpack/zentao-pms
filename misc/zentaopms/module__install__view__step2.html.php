      ...
      <div class='modal-body'>
        <table align='center' class='table table-bordered table-form'>
          ...
          <tr>
            ...
            <td><?php echo html::input('dbHost', '{{.pod__oprep__port__mysql__lan_addr}}', "class='form-control' autocomplete='off'");?></td>
            <td><?php echo $lang->install->dbHostNote;?></td>
          </tr>
          <tr>
            <th><?php echo $lang->install->dbPort;?></th>
            <td><?php echo html::input('dbPort', '{{.pod__oprep__port__mysql__host_port}}', "class='form-control' autocomplete='off'");?></td><td></td>
          </tr>
          <tr>
            <th><?php echo $lang->install->dbUser;?></th>
            <td><?php echo html::input('dbUser', 'dbuser', "class='form-control' autocomplete='off'");?></td><td></td>
          </tr>
          <tr>
            <th><?php echo $lang->install->dbPassword;?></th>
            <td><?php echo html::input('dbPassword', '{{.app__zentaopms_x1__option__cfg__sysinner_mysql__db_auth}}', "class='form-control' autocomplete='off'");?></td><td></td>
          </tr>
          <tr>
            <th><?php echo $lang->install->dbName;?></th>
            <td><?php echo html::input('dbName', 'dbaction', "class='form-control' autocomplete='off'");?></td><td></td>
          </tr>
          <tr>
